...
import com.example.falldetection.data.datasource.ResponseResultService
...
interface ObserverRequestService {
    @POST("/")
    suspend fun sendObserverRequest(@Body observerRequest: ObserverRequest) : Response<ResponseResultService<Nothing>>
}